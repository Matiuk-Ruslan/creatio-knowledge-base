define('BaseSetupTelephonyParametersPageResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
        HeaderCaption: 'Базовая настройка параметров телефонии',
        SaveButtonCaption: 'Сохранить',
        CancelButtonCaption: 'Отмена',
        DebugModeCaption: 'Включить режим отладки',
        DisableCallCentreCaption: 'Отключить интеграцию с Сontact Сentre',
        FieldValidationError: 'Поле \"{0}\": {1}',
        UseBlindTransferCaption: 'Использовать безусловный перевод'
    };
...
define('BaseSetupTelephonyParametersPageStructure', ['BaseSetupTelephonyParametersPageResources'], function (resources) {
    return {
        schemaUId: '22849db5-f5d9-4326-8fbc-af1f1888a90e', schemaCaption: "Базовая страница настроек параметров телефонии", parentSchemaName: "", packageName: "CTIBase", schemaName: 'BaseSetupTelephonyParametersPage', parentSchemaUId: '', extendParent: false, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: 'Terrasoft.model.BaseViewModel', schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {
