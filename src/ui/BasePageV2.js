...
core.setModuleDescriptor('BasePageV2CrtNUIResources', { path: "configuration/cd36f5120cf14db89ea1655ed18c96a6ru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2CrtWizards7xResources', { path: "configuration/836ec544d77a61fa397a87bf5e55c7afru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2GoogleTagManagerMeasurementsResources', { path: "configuration/8dd66e7cdabfc8dea79d0e937dc63859ru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2MLResources', { path: "configuration/cafe2cd3ccd219fdd997ccd06ba1be0bru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2CrtDeduplicationResources', { path: "configuration/043c507fee1b5817b7cee87cfbdc62e1ru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2OperatorSingleWindowResources', { path: "configuration/08b53d1c83ca7bc1f6ce98ec8463f8f4ru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2SSPResources', { path: "configuration/ebeb766b880ae3cb5fc53743a687fcecru-RU", isResourceModule: true });
core.setModuleDescriptor('BasePageV2OBSWResources', { path: "configuration/451fd571c5a3f55200eadfba686ad1c4ru-RU", isResourceModule: true });
define('BasePageV2Resources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
        BulkClientNotificationHistoryMessageTemplate: '{0}: {1}',
    ...
    var localizableImages = {
        "BackButtonImage": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "BackButtonImage", "hash": "638af7d7df9879b2c8f3b1bb7eb0f788" } },
        "CloseButtonImage": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "CloseButtonImage", "hash": "511593df65946d88744783400c622cdb" } },
        "ProcessButtonImage": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "ProcessButtonImage", "hash": "b2718527a6bf360a3e641e9cb3a00904" } },
        "QuickAddButtonImage": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "QuickAddButtonImage", "hash": "bbcac9c59db676c3f206809cbdbd3244" } },
        "AnalyticsDataIcon": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "AnalyticsDataIcon", "hash": "797f9955cfd47e5ca74c16a682de6853" } },
        "GridSettingsIcon": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "GridSettingsIcon", "hash": "c4949763b4bc893604fbb2d5d458a028" } },
        "OpenChangeLogBtnImage": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "OpenChangeLogBtnImage", "hash": "cbebcb32589828e1055caf62150ff717" } },
        "ExistsClientNotificationHistory": { "source": 3, "params": { "schemaName": "BasePageV2", "resourceItemName": "ExistsClientNotificationHistory", "hash": "addca2c7acb57fa557a2da76925b5882" } }
    };
    return { localizableStrings: localizableStrings, localizableImages: localizableImages };
});
define('BasePageV2CrtNUIResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
...
define('BasePageV2CrtWizards7xResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
...
define('BasePageV2CrtDeduplicationResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
...
define('BasePageV2SSPResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
...
define('BasePageV2OBSWResources', ['terrasoft'], function (Terrasoft) {
    var localizableStrings = {
...
Terrasoft.configuration.Structures["BasePageV2"] = { innerHierarchyStack: ["BasePageV2CrtNUI", "BasePageV2CrtWizards7x", "BasePageV2GoogleTagManagerMeasurements", "BasePageV2ML", "BasePageV2CrtDeduplication", "BasePageV2OperatorSingleWindow", "BasePageV2SSP", "BasePageV2OBSW", "BasePageV2"], structureParent: "BaseEntityPage" };
define('BasePageV2CrtNUIStructure', ['BasePageV2CrtNUIResources'], function (resources) {
    return {
        schemaUId: 'd3cc497c-f286-4f13-99c1-751c468733c0', schemaCaption: "Базовая схема карточки", parentSchemaName: "BaseEntityPage", packageName: "ELBase", schemaName: 'BasePageV2CrtNUI', parentSchemaUId: '81c2ebad-7f20-4e71-b0c6-941b1422ba62', extendParent: false, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: 'Terrasoft.model.BaseViewModel', schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2CrtWizards7xStructure', ['BasePageV2CrtWizards7xResources'], function (resources) {
    return {
        schemaUId: '12205f8d-6998-49ff-ae0d-9c67df80dff2', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2CrtNUI", packageName: "ELBase", schemaName: 'BasePageV2CrtWizards7x', parentSchemaUId: 'd3cc497c-f286-4f13-99c1-751c468733c0', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2CrtNUI", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2GoogleTagManagerMeasurementsStructure', ['BasePageV2GoogleTagManagerMeasurementsResources'], function (resources) {
    return {
        schemaUId: '3dce6b13-5d69-4e5d-ac7c-0205e8dd944d', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2CrtWizards7x", packageName: "ELBase", schemaName: 'BasePageV2GoogleTagManagerMeasurements', parentSchemaUId: '12205f8d-6998-49ff-ae0d-9c67df80dff2', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2CrtWizards7x", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2MLStructure', ['BasePageV2MLResources'], function (resources) {
    return {
        schemaUId: '4aef9a3f-5e52-4aa6-ab74-36e106a4d17b', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2GoogleTagManagerMeasurements", packageName: "ELBase", schemaName: 'BasePageV2ML', parentSchemaUId: '3dce6b13-5d69-4e5d-ac7c-0205e8dd944d', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2GoogleTagManagerMeasurements", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2CrtDeduplicationStructure', ['BasePageV2CrtDeduplicationResources'], function (resources) {
    return {
        schemaUId: '92244117-272f-4a5e-8d8c-9818b258c265', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2ML", packageName: "ELBase", schemaName: 'BasePageV2CrtDeduplication', parentSchemaUId: '4aef9a3f-5e52-4aa6-ab74-36e106a4d17b', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2ML", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2OperatorSingleWindowStructure', ['BasePageV2OperatorSingleWindowResources'], function (resources) {
    return {
        schemaUId: 'd3e2c3b2-19b8-4cd1-943c-795f543ffb08', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2CrtDeduplication", packageName: "ELBase", schemaName: 'BasePageV2OperatorSingleWindow', parentSchemaUId: '92244117-272f-4a5e-8d8c-9818b258c265', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2CrtDeduplication", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2SSPStructure', ['BasePageV2SSPResources'], function (resources) {
    return {
        schemaUId: '9cdd4610-4b3d-42ea-bb82-78180ae0f14c', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2OperatorSingleWindow", packageName: "ELBase", schemaName: 'BasePageV2SSP', parentSchemaUId: 'd3e2c3b2-19b8-4cd1-943c-795f543ffb08', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2OperatorSingleWindow", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2OBSWStructure', ['BasePageV2OBSWResources'], function (resources) {
    return {
        schemaUId: 'a5c5f5d6-7478-4a84-87d0-183e1a15cf45', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2SSP", packageName: "ELBase", schemaName: 'BasePageV2OBSW', parentSchemaUId: '9cdd4610-4b3d-42ea-bb82-78180ae0f14c', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2SSP", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {

        }
    };
});
define('BasePageV2Structure', ['BasePageV2Resources'], function (resources) {
    return {
        schemaUId: '777d6070-c7f6-4f03-a23b-ef998d4a3709', schemaCaption: "Базовая схема карточки", parentSchemaName: "BasePageV2OBSW", packageName: "ELBase", schemaName: 'BasePageV2', parentSchemaUId: 'a5c5f5d6-7478-4a84-87d0-183e1a15cf45', extendParent: true, type: Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA, entitySchema: '', name: '', extend: "BasePageV2OBSW", schema: { leftPanel: [], rightPanel: [], actions: [], analytics: [] }, methods: {}, controlsConfig: {}, customBindings: {}, bindings: {}, schemaDifferences: function () {
 ...
 */
define("BasePageV2CrtNUI", ["performancecountermanager", "ChangeLogUtilities",
...
define("BasePageV2CrtWizards7x", [], function () {
    return {};
});
...
define("BasePageV2CrtDeduplication", ["css!DuplicatesWidgetModule"], function () {
    return {
        details: /**SCHEMA_DETAILS*/{}/**SCHEMA_DETAILS*/,
        modules: /**SCHEMA_MODULES*/{}/**SCHEMA_MODULES*/,
        attributes: {
...
define("BasePageV2SSP", ["PortalClientConstants", "SchemaAccessControllerMixin"], function (PortalConsts) {
    return {
        details: /**SCHEMA_DETAILS*/{}/**SCHEMA_DETAILS*/,
        modules: /**SCHEMA_MODULES*/{}/**SCHEMA_MODULES*/,
        mixins: {
...
define("BasePageV2OBSW", [], function () {
    return {
        messages: {
...
define("BasePageV2", [
    ...
    "@maib",
    "css!ELCommonCSS",
    "css!ELClient360DetailsCSS"
], function (sdk, maib) {
    return {
        messages: {
            GetDisableExclusionsDetails: {
                mode: Terrasoft.MessageMode.PTP,
                direction: Terrasoft.MessageDirectionType.SUBSCRIBE
            },
            ReloadCombinedModePrintReportMenuItems: {
                mode: Terrasoft.MessageMode.PTP,
                direction: Terrasoft.MessageDirectionType.PUBLISH
            },
            ShowClientMessage: {
        ...
        attributes: {
            ...
            ClientMessageContactPath: { dataValueType: Terrasoft.DataValueType.TEXT },
            ClientMessageAccountPath: { dataValueType: Terrasoft.DataValueType.TEXT },
            CanEditRecord: { dataValueType: Terrasoft.DataValueType.BOOLEAN },
            IsExistsClientNotificationHistoryButtonVisible: {
                dataValueType: Terrasoft.DataValueType.BOOLEAN,
        ...
        diff: /**SCHEMA_DIFF*/[
            {
                operation: "insert",
                name: "ExistsClientNotificationHistoryButton",
                parentName: "LeftContainer",
                propertyName: "items",
                values: {
                    itemType: Terrasoft.ViewItemType.BUTTON,
                    imageConfig: { bindTo: "Resources.Images.ExistsClientNotificationHistory" },
                    classes: {
                        wrapperClass: ["el-service-grid-button-icon-wrapper"],
                        imageClass: ["el-grid-button-icon"]
                    },
                    visible: { bindTo: "IsExistsClientNotificationHistoryButtonVisible" },
                    hint: { bindTo: "ClientNotificationHistory" }
                }
            }
        ]/**SCHEMA_DIFF*/,
        ...
        methods: {
            /**
             * @inheritDoc BasePageV2#onPageInitialized
             * @override
             */
            onPageInitialized: function () {
                let parentMethod = this.getParentMethod(this, arguments);
                this.initPageViewLogSettings().then(parentMethod);
            },
            ...
            onEntityInitialized: function () {
                this.callParent(arguments);
                this.createInitPageViewLog();
            },

            /**
             * @inheritDoc PrintReportUtilities#generatePrintForm
             * @override
             */
            generatePrintForm: function (printForm) {
                this.callParent(arguments);
                maib.services.PrintLogService.logPrintForm(
                    this.entitySchemaName, printForm, this.getPrimaryColumnValue());
            },

            /**
             * @inheritDoc BasePageV2#subscribeDetailEvents
             * @override
             */
            subscribeDetailEvents: function (detailConfig, detailName) {
                this.callParent(arguments);
                this.sandbox.subscribe("GetDisableExclusionsDetails",
                    this.getDisableExclusionsDetailSchemaNames, this, [this.getDetailId(detailName)]);
                this.sandbox.subscribe("GetDetailSandboxId",
                    this.getDetailId, this, [this.getDetailId(detailName)]);
                this.sandbox.subscribe("GetIsAttributeChanged",
                    this.isAttributeChanged, this, [this.getDetailId(detailName)]);
            },
            ...
            subscribeSandboxEvents: function () {
                this.callParent(arguments);
                this.subscribeShowClientMessage();
                this.subscribeCombinedModePrintFormClick();
            },

            /**
             * @inheritDoc BasePageV2#postponeQueueItem
             * @override
             */
            postponeQueueItem: function (queueItemId, callback) {
                const newCallback = function (success) {
                    this.resetPostponedQueueItemProcess(queueItemId).then(() => callback(success));
                };
                this.callParent([
                    queueItemId,
                    newCallback.bind(this)
                ]);
            },

            /**
             * @inheritDoc BasePageV2.NUI#loadLookupDisplayValueAsync
             * @override
             */
            loadLookupDisplayValueAsync: function (name, value) {
                return new Promise(resolve => this.loadLookupDisplayValue(name, value, () => resolve(), this));
            },

            /**
             * PrintReportUtilities#initCardPrintForms
             * @override
             */
            initCardPrintForms: function (callback, scope) {
                this.initializingCardPrintForms(callback, scope);
            },

            initializingCardPrintForms: function (callback, scope) {
                if (this.isEditMode()) {
                    this.setAvailableReports()
                        .then(this.callParentInitCardPrintForms.bind(this, callback, scope));
                } else {
                    this.callParentInitCardPrintForms(callback, scope);
                }
            },

            /**
             * @inheritDoc PrintReportUtilities#initCardPrintFormsEsqFilters
             * @override
             */
            initCardPrintFormsEsqFilters: function (reportEsq) {
                let availableReports = this.$AvailableReports ?? [];
                let filterGroup = Terrasoft.createFilterGroup();
                if (availableReports.length) {
                    filterGroup.add("Available", Terrasoft.createColumnInFilterWithParameters("Id", availableReports));
                } else {
                    filterGroup.add("NoAvailable", Terrasoft.createColumnIsNullFilter("Id"));
                }
                reportEsq.filters.addItem(filterGroup);
            },

            /**
             * @inheritDoc BasePageV2#activeTabChange
             * @override
             */
            activeTabChange: function (activeTab) {
                this.callParent(arguments);
                this.createPageViewTabLog(activeTab.get("Name"));
            },
            ...
            onSaved: function () {
                ...
                this.saveMultiSelect().then(parentMethod);
            },
            ...
            onDiscardChangesClick: function () {
                this.discardMultiSelect();
                this.callParent(arguments);
            },

            /**
             * Showing invalidate message if card not valid.
             * @param {Object} options Used for skipping columns validation
             * For example: {SomeColumnName: {skipValidation: true}}
             * @returns {Boolean} True if card is valid.
             */
            onValidateCardWithOptions: function (options) {
                let isValid = this.validateWithOptions(options);
                if (isValid) {
                    return true;
                }
                let validateConfig = {
             ...
             * @param {Object} options Used for skipping columns validation
             * For example: {SomeColumnName: {skipValidation: true}}
             * @returns {Boolean} Returns true on success of all validators
             */
            validateWithOptions: function (options) {
                let result = true;
                if (this.validationConfig) {
                    let sortedByValidationOrder = Terrasoft.sortObj(this.columns, "validateOrder");
                    Terrasoft.each(sortedByValidationOrder, function (column, columnName) {
                        result = result && this.validateColumn(columnName, options[columnName]);
                    }, this);
            ...
            resetPostponedQueueItemProcess: async function (queueItemId) {
                ...
                update.setParameterValue("SysProcessDataId", null, Terrasoft.DataValueType.GUID);
                await update.executeAsync();
            },

            callParentInitCardPrintForms: function (callback, scope) {
                let reportsEsq = this.getModulePrintFormsESQ();
                this.initCardPrintFormsEsqFilters(reportsEsq);
                reportsEsq.getEntityCollection(function (result) {
                    if (this.destroyed) {
                        return;
                    }
                    this.onModulePrintFormsDataLoaded(result);
                    Ext.callback(callback, scope || this);
                }, this);
            },

            onModulePrintFormsDataLoaded: function (result) {
                if (result.success && !result.collection.isEmpty()) {
                    let printFormsMenuCollection = result.collection.filterByFn(function (item) {
                    ...
                    let printMenuItems = this.preparePrintButtonCollection(this.moduleCardPrintFormsCollectionName);
                    ...
                    this.publishReloadCombinedModePrintReportMenuItems(printMenuItems);
                }
            },

            publishReloadCombinedModePrintReportMenuItems: function (collection) {
                this.sandbox.publish("ReloadCombinedModePrintReportMenuItems", {
                    collectionName: this.moduleCardPrintFormsCollectionName,
                    newCollection: collection
                }, [this.sandbox.id]);
            },

            addColumnsToLookupConfig: function (columnName, lookupColumnNames) {
                let column = this.columns[columnName];
                if (column) {
                    let lookupColumns = column.lookupListConfig?.columns ?? [];
                    lookupColumnNames.forEach(item => {
                        if (!lookupColumns.includes(item)) {
                            lookupColumns.push(item);
                        }
                    });
                    column.lookupListConfig = Ext.apply(column.lookupListConfig ?? {}, { columns: lookupColumns });
                }
            },

            initPageViewLogSettings: async function () {
                let logObject = (await this.fetchRecordLogObject()).find(e => e.$SchemaName === this.entitySchemaName);
                this.set("PageViewLogEnabled", this.isEditMode() && !!logObject);
                this.set("PageViewTabLogEnabled", this.isEditMode() && logObject?.$TabLog);
                this.set("PageViewLogClientPath", logObject?.$ClientColumnPath);
                this.set("PageViewLogLegalEntityPath", logObject?.$LegalEntityColumnPath);
            },

            fetchRecordLogObject: async function () {
                let esq = this.Ext.create("Terrasoft.EntitySchemaQuery", {
                    rootSchemaName: "ELRecordLogObject",
                    clientESQCacheParameters: {
                        cacheItemName: "RecordLogObject"
                    }
                });
                esq.addColumn("Object.Name", "SchemaName");
                esq.addColumn("ClientColumnPath");
                esq.addColumn("LegalEntityColumnPath");
                esq.addColumn("TabLog");
                return (await esq.executeAsync()).collection.getItems();
            },

            createInitPageViewLog: async function () {
                await this.createPageViewLog();
                let defaultTabName = this.getDefaultTabName();
                if (defaultTabName) {
                    await new Promise(resolve => setTimeout(resolve, 200));
                    await this.createPageViewTabLog(defaultTabName);
                }
            },

            createPageViewLog: async function () {
                if (this.get("PageViewLogEnabled")) {
                    await this.callPageViewLogService();
                }
            },

            createPageViewTabLog: async function (tabName) {
                if (this.get("PageViewTabLogEnabled")) {
                    await this.callPageViewLogService(tabName);
                }
            },

            callPageViewLogService: async function (tabName) {
                await sdk.http.client.post("syslog/view", {
                    entitySchemaName: this.entitySchemaName,
                    recordId: this.getPrimaryColumnValue(),
                    contactPath: this.$PageViewLogClientPath,
                    accountPath: this.$PageViewLogLegalEntityPath,
                    logEventType: this.getPageViewLogEventType(tabName)
                });
            },

            getPageViewLogEventType: function (tabName) {
                return tabName ? `${this.name}.${tabName}` : this.name;
            },

            subscribeShowClientMessage: function () {
                if (this.$IsShowClientMessage) {
                    this.sandbox.subscribe("ShowClientMessage", this.handleShowClientMessage, this);
                }
            },

            handleShowClientMessage: function (data) {
                if ((this.$ClientMessageContactPath &&
                    (this.get(this.$ClientMessageContactPath)?.value === data.clientId ||
                        this.get(this.$ClientMessageContactPath) === data.clientId)) ||
                    (this.$ClientMessageAccountPath &&
                        (this.get(this.$ClientMessageAccountPath)?.value === data.clientId ||
                            this.get(this.$ClientMessageAccountPath) === data.clientId))) {
                    this.showClientMessage(data);
                }
            },

            showClientMessage: function (data) {
                this.showInformationDialog(data.message.replace(/<a.*?>/, ""), null, {
                    id: "clientMessage"
                });
                document.getElementById("clientMessage-caption").innerHTML = data.message;
            },

            setCanEditRecord: async function () {
                this.$CanEditRecord = await sdk.rights.canEdit({
            ...
            async getExistsClientNotificationHistory(clientId, isClient) {
                if (clientId) {
                    let clientNotificationHistoryItems = await this.getClientNotificationHistoryESQ(clientId, isClient);
                    Promise.all((clientNotificationHistoryItems || [])
                        .map(x => this.getClientNotificationHistoryColumnsValue(x)))
                        .then(result => this.setClientNotificationHistory(result));
                } else {
                    let visibleButton = false;
                    this.set("IsExistsClientNotificationHistoryButtonVisible", visibleButton);
                    this.publishPropertyValueToSection("IsExistsClientNotificationHistoryButtonVisible",
                        visibleButton);
                }
            },

            getClientNotificationHistoryColumnsValue: function (item) {
                return {
                    notificationName: item.$NotificationText,
                    notificationCreatedOn: item.$CreatedOn,
                    notificationTerm: item.$NotificationTerm
                };
            },

            setClientNotificationHistory: function (result) {
                let now = new Date();
                let arr = result.filter(x => {
                    let createdOn = Terrasoft.deepClone(x.notificationCreatedOn);
                    createdOn.setSeconds(createdOn.getSeconds() + x.notificationTerm);
                    return createdOn > now;
                });
                let visibleButton = arr.length > 0;
                this.set("IsExistsClientNotificationHistoryButtonVisible", visibleButton);
                this.publishPropertyValueToSection("IsExistsClientNotificationHistoryButtonVisible", visibleButton);
                let message = (arr || [])
                    .map(x => this.Ext.String.format(
                        this.get("Resources.Strings.BulkClientNotificationHistoryMessageTemplate"),
                        (`<b>${x.notificationCreatedOn.toLocaleString()}</b> `),
                        x.notificationName))
                    .join("<br>");
                this.set("ClientNotificationHistory", message);
                this.publishPropertyValueToSection("ClientNotificationHistory", message);
            },

            async getClientNotificationHistoryESQ(clientId, isClient) {
                const esq = this.Ext.create("Terrasoft.EntitySchemaQuery", {
                    rootSchemaName: "ELClientNotificationHistory"
                });
                esq.addColumn("CreatedOn").orderDirection = this.Terrasoft.OrderDirection.DESC;
                esq.addColumn("CustomerNotification.Name", "NotificationText");
                esq.addColumn("CustomerNotification.Term", "NotificationTerm");

                if (isClient) {
                    esq.filters.add("ContactFilter", this.Terrasoft.createColumnFilterWithParameter(
                        this.Terrasoft.ComparisonType.EQUAL, "Contact", clientId));
                } else {
                    esq.filters.add("AccountFilter", this.Terrasoft.createColumnFilterWithParameter(
                        this.Terrasoft.ComparisonType.EQUAL, "Account", clientId));
                }
                return (await esq.executeAsync())?.collection?.getItems();
            },

            setAvailableReports: async function () {
                let response = await sdk.http.client.get("sys-module-report-conditions/reports", {
            ...
            openLookupAsync: function (config) {
                return new Promise(resolve => this.openLookup(config, resolve, this));
            },

            saveMultiSelect: async function () {
                const multiSelectColumns =
                    Object.getOwnPropertyNames(this.columns).filter(x => this.columns[x].isMultiSelect);

                await Promise.all(
                    multiSelectColumns.map(column => this.executeBatchQuery(column))
                );
            },

            discardMultiSelect: function () {
                const multiSelectColumns =
                    Object.getOwnPropertyNames(this.columns).filter(x => this.columns[x].isMultiSelect);
                multiSelectColumns.forEach(column => {
                    this.fireEvent(`discard:${column}`);
                });
            },

            executeBatchQuery: function (column) {
                const scope = this;
                return new Promise(resolve => {
                    ...
                    values.forEach(x => {
                        if (x.state === "deleted") {
                            batchQuery.add(this.getMultiSelectRecordDelete(this.columns[column], x));
                        } else if (x.state === "new") {
                            batchQuery.add(this.getMultiSelectRecordInsert(this.columns[column], x));
                        }
                    });

                    batchQuery.execute(() => {
                        resolve();
                        scope.fireEvent(`saved:${column}`);
                    });
                });
            },

            getMultiSelectRecordInsert: function (column, multiSelectValue) {
                const insert = Ext.create("Terrasoft.InsertQuery", {
                    rootSchemaName: column.schema
                });
                insert.setParameterValue(column.lookupColumn, multiSelectValue.value, Terrasoft.DataValueType.GUID);
                insert.setParameterValue(column.masterColumn, this.$Id, Terrasoft.DataValueType.GUID);

                return insert;
            },

            getMultiSelectRecordDelete: function (column, masterRecordId) {
            ...
            subscribeCombinedModePrintFormClick: function () {
                this.sandbox.subscribe(
                    "CombinedModePrintFormClick",
                    this.combinedModePrintFormClickHandler,
                    this,
                    [this.sandbox.id]);
            },

            combinedModePrintFormClickHandler: function (tag) {
                let handler = this.getCombinedModePrintFormClickHandlers()[tag];
                handler?.call(this, tag);
            },

            getCombinedModePrintFormClickHandlers: Terrasoft.abstractFn
        }
    };
});
