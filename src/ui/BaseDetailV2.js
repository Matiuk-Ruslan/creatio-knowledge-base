...
core.setModuleDescriptor('BaseDetailV2CrtNUIResources', {path: "configuration/644fce430297b921166ddee3a9cb6aacru-RU", isResourceModule: true});
...
var localizableImages={
	"AddButtonImage": {"source": 3, "params": { "schemaName": "BaseDetailV2", "resourceItemName": "AddButtonImage", "hash": "db1b0d1a50235c598db887d5529030ae" }},
	"ToolsButtonImage": {"source": 3, "params": { "schemaName": "BaseDetailV2", "resourceItemName": "ToolsButtonImage", "hash": "48d545549ca4ddb13d7a7bb58f60ed5e" }}
};
return {localizableStrings:localizableStrings,localizableImages:localizableImages};
});
define('BaseDetailV2CrtNUIResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
Terrasoft.configuration.Structures["BaseDetailV2"] = {innerHierarchyStack: ["BaseDetailV2CrtNUI", "BaseDetailV2"]};
define('BaseDetailV2CrtNUIStructure', ['BaseDetailV2CrtNUIResources'], function(resources) {return {schemaUId:'3052ff9d-521d-4a6d-ba92-04a2261e1ea8',schemaCaption: "Базовая схема детали", parentSchemaName: "", packageName: "ELBase", schemaName:'BaseDetailV2CrtNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDetailV2Structure', ['BaseDetailV2Resources'], function(resources) {return {schemaUId:'458cc161-883e-b602-36a7-0f550ccb9760',schemaCaption: "Базовая схема детали", parentSchemaName: "BaseDetailV2CrtNUI", packageName: "ELBase", schemaName:'BaseDetailV2',parentSchemaUId:'3052ff9d-521d-4a6d-ba92-04a2261e1ea8',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDetailV2CrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
/**
 * Parent: BaseSchemaViewModel
 */
define("BaseDetailV2CrtNUI", ["terrasoft", "RightUtilities", "ConfigurationEnums"],
...
define("BaseDetailV2", [], function() {
	return {
		messages: {
			/**
			 * @message GetDetailProperty
			 * Returns detail's property.
			 */
			GetDetailProperty: {
				mode: Terrasoft.MessageMode.PTP,
		...
		methods: {
			/**
			 * @inheritDoc BaseDetailV2.NUI#onEntityInitialized
			 * @override
			 */
			subscribeSandboxEvents: function() {
				this.callParent(arguments);
				this.subscribeGetDetailPropertyMessage();
			},
			
			subscribeGetDetailPropertyMessage: function() {
				this.sandbox.subscribe("GetDetailProperty", this.get, this, [this.sandbox.id]);
			}
		}
	};
});
